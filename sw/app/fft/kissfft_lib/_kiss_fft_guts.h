...
struct kiss_fft_state{
    ...
    /* CORRECTION : Tableaux fixes pour stockage interne sécurisé */
    int factors[MAXFACTORS];
    kiss_fft_cpx twiddles[512]; // Taille N=512 fixe pour ce projet
};

/* Macros pour le calcul en virgule fixe */
#ifdef FIXED_POINT
#include <stdint.h>
#if (FIXED_POINT==32)
# define FRACBITS 31
...
/* ... (Code float inchangé, omis pour brièveté) ... */
